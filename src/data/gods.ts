...
export const GODS: GodData[] = [
  {
    ...
    tagline: 'The Mother of Seasons — goddess of the untamed world.',
...
Importantly, metallic dragons are not "good" in any simple sense — most are Lawful, and mortals who deal with them often find them Lawful Evil. Calitax's creation reflects this.`,
  ...
  },
  {
    ...
    tagline: "The Isolate Maker — forge deity, inventor of civilization's tools.",
    description: `God of invention and the forge, credited (alongside collaborating deities) with fundamental inventions: the ship, the wheel, weaponry. Kaynan is famously isolationist — unlike the more sociable members of the pantheon, he is rarely depicted in divine company. His relationship with Raxos is notably rocky; she steals credit for things she helped him build.`,
